...
```bash
wget -qO- https://raw.githubusercontent.com/CyPack/claude-code-optimization-for-opensource-providers/main/scripts/install-from-github.sh | bash
```
...
```bash
INSTALL_DIR="$HOME/bin" bash -c "$(curl -fsSL https://raw.githubusercontent.com/CyPack/claude-code-optimization-for-opensource-providers/main/scripts/install-from-github.sh)"
```
